...
\begin{tabular}{l l l l} \hline 
    \multicolumn{1}{p{1.7cm}}{\textbf{\vspace{Education}}}    & 
        \multicolumn{3}{p{17cm}}{
        \leftright{\textbf{University of California: Los Angeles, 2019}}\newline
        \textit{Degrees:} B.S. Mathematics of Computation with a \newline Minor in Geophysics and Planetary Physics and Atmospheric and Oceanic Sciences \newline
        ...
        \textit{Degrees:} Associates in Mathematics, Assosciates in Physics \newline} \\ \hline
    \multicolumn{1}{p{1.7cm}}{\textbf{\vspace{Skills}}}   &
        \multicolumn{1}{p{8cm}}{
        \textit{Programming:} C/C++, Python, \LaTeX, Matlab \newline
